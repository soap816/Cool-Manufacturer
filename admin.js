...
els.loginForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (!res.ok) {
      els.loginNote.textContent = result.error || 'Incorrect password.';
      return;
    }
    ...
    els.loginNote.textContent = 'Could not reach the server. Try again.';
  }
});
...
els.settingsForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    els.saveNote.textContent = 'Something went wrong saving your changes. Try again.';
  } finally {
